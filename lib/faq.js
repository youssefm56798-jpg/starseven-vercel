  ...
  return ar
    ? [
        ...
        },
        {
          ...
          a: 'في صفحة الرئيسية فيه اختيار نوع الشعر — تدوس على نوع شعرك ويقولك أنهي منتج ليك وليه، ومن أنهي منتج تبعد. كل منتج مكتوب عليه كمان درجة تثبيته من ٥.',
        },
      ]
    : [
        {
        ...
        },
        {
          ...
          a: 'The homepage has a hair-type finder — pick your type and it tells you which product is yours, why, and what to avoid. Every product also lists its hold strength out of 5.',
        },
      ];
}
