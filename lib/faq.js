  ...
  return ar
    ? [
        ...
        },
        {
          ...
          a: 'لأ، ومفيش تسجيل أصلاً. اختار المنتج، ضيفه للسلة، واكتب اسمك وعنوانك وموبايلك وإيميلك في الشيك أوت. هنبعتلك على الإيميل لينك تشوف منه الأوردر وحالته وتقدر تطلب إلغاء — من غير باسورد تفتكره.',
        },
        {
          q: 'لو المنتج وصلني غلط أو تالف؟',
          a: `كلّمنا على واتساب على ${site.whatsapp.replace(/^20/, '0')} وهنستبدله بالصح أو نرجّعلك فلوسك، والشحن علينا. وعموماً تقدر تستبدل أو ترجّع أي منتج خلال ١٤ يوم من الاستلام لو لسه بحالته الأصلية ومتستخدمش وبعلبته وملحقاته كاملة — التفاصيل في صفحة الشروط والأحكام.`,
        },
        {
    ...
    : [
        ...
        },
        {
          ...
          a: 'No, and there is no sign-up. Pick a product, add it to the cart, and enter your name, address, mobile and email at checkout. We email you a link that shows your order, its status, and lets you ask to cancel it — no password to remember.',
        },
        {
          q: 'What if it arrives damaged or wrong?',
          a: `Message us on WhatsApp on ${site.whatsapp.replace(/^20/, '0')} and we will exchange it for the right one or refund you, with delivery at our cost. More generally, you can exchange or return any product within 14 days of receiving it if it is unused, in its original condition, with the box and accessories complete — the full terms are on the Terms page.`,
        },
        {
