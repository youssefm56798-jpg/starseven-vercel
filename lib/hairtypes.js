...
export const HAIR_TYPES = [
  ...
  },
  {
    ...
    "ar": {
      ...
      "answer": "مفيش عندنا كلاي ولا معجون مطفي — فالإجابة الصادقة هنا هي أقل كمية ممكنة من أمرن تركيبة عندنا. حتة صغيرة تتدفي بين إيديك الأول، وتتحط والشعر ناشف، من نص الطول لبره مش من الجذور.",
      "avoid": "ابعد خالص عن البوميد التقيل وزبدة الشيا — بيوقّعوا الشعر الخفيف. ومتحطش أي حاجة والشعر مبلول: المية مع المنتج هي اللي بتلزقه في الفروة."
    },
    "en": {
      "name": "Fine & thin",
      ...
      "answer": "We do not make a clay or a matte paste, so the honest answer here is the smallest amount of the most flexible thing we do make. Warm it between the palms, work it through dry hair from mid-length out, and keep it off the roots.",
      "avoid": "Stay away from heavy pomades and shea butter — both weigh fine hair down. And nothing goes on wet: water plus product is what flattens it against the scalp."
    },
