 ...
 *
 * `why` and `answer` say the same thing at two lengths, and the difference is
 * the slot each is written for. The index renders seven tiles at once, so it
 * gets `why`: one line, the verdict, sitting directly above the jar it argues
 * for. `answer` is the paragraph, and it only ever appears on the tile’s own
 * page and in that page’s FAQ schema, where a reader has already chosen this
 * one type and is asking to be convinced.
 *
 * The index used to render `problem`, `answer` and `avoid` in full on all seven
 * cards. Seven cards times three paragraphs is a wall nobody reads, and it also
 * published the type pages' own copy a second time under a different URL.
 */
export const HAIR_TYPES = [
  {
    ...
    "ar": {
      "name": "ناعم مفرود",
      "why": "تثبيت عالي من غير وزن — والجل بس اللي بيعمل الاتنين.",
    ...
    "en": {
      "name": "Straight",
      "why": "High hold with zero weight. Only gel does both.",
      "short": "Style drops, gets oily fast",
      "problem": "Straight hair loses its shape fast, and scalp oil runs straight down the shaft, so it goes greasy sooner than any other type.",
      "answer": "You need high hold and zero weight. Gel is the only format strong enough to hold a shape on hair that fights holding one.",
  ...
  },
  {
    ...
    "ar": {
      "name": "متموج",
      "why": "واكس مرن بلمعة طبيعية — بيعرّف الموجة مش بيفردها.",
    ...
    "en": {
      "name": "Wavy",
      "why": "A flexible wax with a natural finish. It shapes the wave instead of flattening it.",
      "short": "Waves drop out and frizz",
      "problem": "Wavy hair fights styling and frizzes easily, and most products flatten the wave instead of shaping it.",
      "answer": "Medium-high hold with a natural finish defines the S-pattern instead of gluing it flat. That’s exactly what the Wave & Groom formula in Pro X is built for.",
  ...
  },
  {
    ...
    "ar": {
      "name": "كيرلي",
      "why": "زيت خفيف بيدخل جوه الشعرة — ترطيب من غير ما يوقّع الكيرلة.",
    ...
    "en": {
      "name": "Curly",
      "why": "A light oil that goes into the strand — moisture without dropping the curl.",
      "short": "Dry, needs definition",
      "problem": "Curly hair needs two things at once: definition and moisture. Most products give you one at the cost of the other.",
  ...
  },
  {
    ...
    "ar": {
      "name": "خشن / أفرو",
      "why": "زبدة تقيلة بتقفل الرطوبة جوه الشعرة الخشنة.",
    ...
    "en": {
      "name": "Coily / Afro",
      "why": "A heavy butter that seals moisture into a coarse strand.",
      ...
      "answer": "Shea butter seals moisture into coarse, coily strands and softens them. It’s the standard recommendation for thick, coarse and curly hair.",
  ...
  },
  {
    ...
    "ar": {
      "name": "خفيف",
      "why": "كلاي مطفي — حجم من غير لمعة ومن غير وزن.",
    ...
    "en": {
      "name": "Fine & thin",
      "why": "A matte clay — volume, without the shine or the weight.",
      "short": "Needs volume, heavy kills it",
      "problem": "Fine hair needs volume, and anything heavy or shiny glues it to the scalp so it looks like there’s even less of it.",
      "answer": "Clay wax. It’s the one format built for exactly this: firm hold with a matte finish, so you get volume without the shine and without the weight. A pea, warmed in your palms, through dry hair, mid-length out. Nothing at the roots.",
  ...
  },
  {
    ...
    "ar": {
      "name": "كثيف",
      "why": "أقوى تثبيت عندك — ده النوع الوحيد اللي بيستحمله.",
    ...
    "en": {
      "name": "Thick & coarse",
      "why": "The strongest hold you have. The one density that can carry it.",
      "short": "Heavy hair, drops fast",
      "problem": "Thick hair collapses under its own weight. It needs the strongest hold you have, and light formulas just don’t survive the day.",
      ...
      "avoid": "Light formulas won’t last. Expect the style to drop by midday."
    },
  ...
  },
  {
    ...
    "ar": {
      "name": "أبيض وشيب",
      "why": "أسود بيغمّق الشيب وهو بيثبّت — مش صبغة.",
    ...
    "en": {
      "name": "White & grey",
      "why": "Black that knocks the grey back as it holds. Not a dye.",
      ...
      "answer": "The black products. They’re not a dye. They darken white hair by roughly 30–40%, depending on how white it is and how much of it there is, and the colour leaves on the first wash. Black exists in the gel, the premium wax, the gel wax and the cream gel.",
      "avoid": "Don’t expect full, even coverage. It’s not a dye and doesn’t pretend to be one. And don’t overload it: whatever doesn’t grip the strand ends up on your collar and your pillow."
    },
