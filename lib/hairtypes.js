...
export const HAIR_TYPES = [
  ...
  },
  {
    ...
    "ar": {
      ...
      "answer": "مفيش حاجة عندنا اتعملت للشعر الخفيف. اللي انت محتاجه كلاي أو معجون مطفي، وده مبنعملهوش. أقرب حاجة: حتة قد الحمصة، دوّبها في إيدك، وحطها والشعر ناشف من نص الطول لبره. الجذور لأ.",
      "avoid": "البوميد التقيل وزبدة الشيا هيوقّعوه. والشعر المبلول زيهم — المية مع المنتج هي اللي بتلزقه في فروتك."
    },
    "en": {
      "name": "Fine & thin",
      ...
      "answer": "Nothing we make was built for this. What you want is a clay or a matte paste and we do not sell one. Closest you will get: a pea of Pro, warmed in your palms, through dry hair, mid-length out. Nothing at the roots.",
      "avoid": "Heavy pomades and shea butter will flatten it. So will wet hair — water plus product is what glues it to your scalp."
    },
