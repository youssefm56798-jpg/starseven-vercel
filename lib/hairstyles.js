 ...
 * fine-hair tile, and for the same missing SKU. This set is the 2026 rebuild:
 ...
 * the look: 'yes' for the four it serves properly, 'partly' for the curtains
 * tile where the closest active product (Shea) is a genuine compromise rather
 * than the light cream the centre part is actually built for, and 'no' for the
 * crop. It is data rather than a slug check in the views because it decides two
 * visible things — whether the jar is offered as the answer or as the nearest
 * thing, and whether a tile is allowed to list alternates at all. A look the
 * range cannot serve has no second-best, and offering one would undo the
 * admission the tile just made.
 *
...
export const HAIR_STYLES = [
  {
    ...
    en: {
      ...
      look: 'Everything combed back, nothing standing up. The wet shine is on purpose — you want it looking styled, not like you just rolled out of bed. Best on straight or wavy hair. If yours is fine, you will need more hold to keep it back.',
      why: 'The Blue gel. Hold 5 and the highest shine in the range — Ovanza rate this one Strong Shine themselves. Wax is the wrong tool: it shines, but it holds at 4 and never sets, so the front drops back down inside two hours. A wedding, or a long day out in the heat? Once it dries, one light pass of the spray over the top locks the shape and stops it moving.',
      steps: [
      ...
      avoid: 'Never on dry hair — it clumps and flakes white. And do not add more to buy more hold; the extra just runs down your forehead when you sweat.',
    },
  },
  {
    slug: 'low-taper-fade',
  ...
  },
  {
    ...
    en: {
      ...
      look: 'Your hair is already curly. The job is making the curl show — each one keeping its own shape instead of merging with its neighbours into one cloud. Most products kill frizz by flattening the curl, and then you have lost the thing you wanted.',
      why: 'The Argan wax. Hold 3, and that is deliberate — a curl has to keep moving, and anything stronger locks it shut. Argan oil is light enough to go into the strand instead of sitting on top, so it softens coarse curl and adds shine without the weight that drops it.',
      steps: [
  ...
  },
  {
    ...
    en: {
      ...
      why: 'The lightest thing you own. Curtains do not want strong hold, they want movement. Glue it down with gel and the part looks drawn on with a ruler, when it should look natural. The Shea wax is the least shiny in the range, hold 3 and flexible — it holds the part and lets the hair move.',
      steps: [
  ...
  },
  {
    ...
    en: {
      ...
      look: 'The front is lifted up and swept back into a wave above the forehead. But the modern quiff is softer and more natural than the old tall pompadour — that is the one people wear now. And the part most men get wrong: the height comes from the dryer. The jar only holds it there.',
      why: 'The red Pro X. Hold 4, medium flexibility — the only one like that in the whole range. That is what makes it keep the shape you set instead of relaxing out of it through the day. The height itself is the dryer, not the jar. Want it standing till the end of the night? Once you are done, one light pass of spray locks it.',
      steps: [
      ...
      avoid: 'Do not put wax in while the hair is still wet, or before the dryer. It goes heavy and drops, and you will blame the hold when the order was the problem.',
    },
  },
  {
    slug: 'textured-crop',
    ...
    ar: {
      ...
      why: 'الكروب بيتعمل بكلاي أو معجون مطفي، وإحنا مش عاملين ولا واحد فيهم. كل حاجة في التشكيلة دي شمع وفازلين، وكلها بتلمع، وأول ما اللمعة تنزل على كروب بيتحوّل من "مكركب" لـ"مدهون". أقل واكس لامع عندنا الشيا — لو هتجرب، جرّب بيه، بنص الكمية اللي في دماغك، وعلى شعر ناشف تماماً. بس اعرف إنك بتقرّب من الشكل، مش بتوصله.',
      steps: [
    ...
    en: {
      ...
      look: 'Short sides, a choppy layered top, fringe pushed forward onto the forehead. The whole thing lives on looking dry — as if there is nothing in your hair and it fell that way. And it is the cut most men are asking for right now.',
      why: 'A crop is built with clay or a matte paste, and we make neither. Everything here is wax and petrolatum, and all of it shines — and shine on a crop turns it from choppy to oily. The least shiny wax we sell is the Shea. If you want to try, use that one, half what you think, on bone-dry hair. Just know you are getting close to the look, not landing it.',
      steps: [
