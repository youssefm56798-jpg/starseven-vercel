...
export const HAIR_STYLES = [
  ...
  },
  {
    ...
    en: {
      ...
      why: 'The clay wax. It is the only format that gives firm hold and a matte finish at once, which is what keeps the pieces separated and the hair reading dry. It is not on the shop yet — until it is, the least shiny wax we sell is the Shea: half what you think, on bone-dry hair. Just know that wax shines, and shine on a crop turns it from choppy to oily, so you are getting close to the look rather than landing it.',
      steps: [
