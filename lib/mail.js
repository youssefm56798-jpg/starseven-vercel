...
<tr><td align="center" style="background:${C.paper};padding:24px 26px 18px;">
  <a href="${site.url}" style="text-decoration:none;"><img src="${site.url}/assets/logo-s7-mail.png"
    width="176" height="76" alt="NEW STAR SEVEN"
    style="display:block;width:176px;height:76px;border:0;outline:none;color:${C.ink};
