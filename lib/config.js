...
export const limits = {
  ...
  // Customer accounts. Two buckets guard login: one keyed by IP, which stops
  // a single host working through a list of addresses, and one keyed by the
  // account being tried, which stops a botnet working through passwords for
  // one address. Neither alone is enough.
  cLoginIp: [10, 900],
  cLoginAccount: [5, 900],
  cRegister: [5, 3600],
  cRefresh: [60, 3600],
