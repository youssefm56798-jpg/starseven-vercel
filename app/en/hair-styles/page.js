...
import { styleIndexMeta } from '../../hair-styles/lib.js';
 ...
 */
export const metadata = styleIndexMeta('en');

export default function EnHairStylesPage() {
  return <HairStylesIndexView lang="en" />;
}
