...
import {
  ld, typeRange, formatCounts, gapNote, indexMeta, indexLd, breadcrumbLd,
} from './lib.js';
...
export async function generateMetadata({ searchParams }) {
  ...
  return indexMeta(sp?.lang === 'en' ? 'en' : 'ar');
}
...
export default async function HairTypesPage({ searchParams }) {
  const sp = await searchParams;
