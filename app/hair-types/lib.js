...
const GAPS = {
  fine: {
    ar: 'ملحوظة بصراحة: الحاجة المتعملة مخصوص للشعر الخفيف اللي عايز حجم هي الطين (clay) أو المعجون المطفي — وإحنا لسه مبنعملهاش. الواكس الأسود المطفي هو أقرب حاجة عندنا للغرض ده، وبنرشحهولك على الأساس ده.',
    en: 'Said plainly: the format built for fine hair that needs volume is a clay or a matte paste, and we do not make one yet. Black Matte wax is the closest thing in our range, and that is the basis we recommend it on.',
  },
  curly: {
