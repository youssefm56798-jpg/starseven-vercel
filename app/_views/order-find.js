    ...
    <Dir lang={ar ? 'ar' : 'en'}>
      ...
      <div className="wrap ordpage">
        ...
        <p className="ord-lead">
          {ar
            ? 'اكتب الإيميل اللي طلبت بيه ورقم الأوردر، وهنبعتلك لينك جديد للمتابعة. رقم الأوردر موجود في إيميل تأكيد الأوردر وشكله كده: S7-2708-1234'
            : 'Enter the email you ordered with and your order number, and we will send you a fresh tracking link. The number is in your order confirmation email and looks like this: S7-2708-1234'}
        </p>
